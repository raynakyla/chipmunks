...
<body class="font-sans flex flex-col h-full overflow-x-hidden mt-5">
  ...
  <header class="container mx-auto px-4 py-4 flex justify-between items-center fixed md:relative z-20 bg-transparant backdrop-blur">
    ...
    <div class="flex items-center">
        <a href="#" class="text-2xl font-bold">
            <span class="text-primary">Ngana</span><span class="text-secondary">Ngunu</span>
        </a>
    </div>

    <!-- Ikon-ikon Aksi -->
    <div class="flex flex-col md:flex-row items-center space-x-4 gap-2">
        <a href="#" class="border border-primary text-secondary px-4 py-2 rounded-md text-center hover:bg-black hover:text-white transition">
            SignUp
        </a>
        <a href="#" class="text-secondary hover:text-primary hover:underline transition">Login</a>
    </div>
</header>
